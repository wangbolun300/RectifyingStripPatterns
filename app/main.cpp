...
#include <iostream>
std::string tmppath = "/Users/wangb0d/bolun/D/vs/libigl-example-project/libigl-tutorial-data-master";
...
int main(int argc, char *argv[])
{
  ...
  Eigen::MatrixXi F;
  Eigen::MatrixXd V;
  igl::read_triangle_mesh( argc>1?argv[1]: tmppath+ "/beetle.off",V,F);
